...
public enum ItemTemplate {//TODO check all dimensions, add height,
    ...
    BS_220X250_GH_LR("220x250 GH-LR", 80, 141, 1, 235, true, true, false),
    ...
    BS_300X320_GH_LR("300x320 GH-LR", 117, 205, 1, 605, true, true, false),
    ...
    BS_340_KATANA_X_CNC_LR("340 Katana X-CNC-LR", 245, 272, 1, 2150),
    ...
    RT_RDT_1000_520("RDT 1000/520", 70, 105, 80, 164, true),
