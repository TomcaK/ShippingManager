...
public class ConsoleUI {
    ...
    public void selectionOfTrailer() {
        ...
        do {
             input = input();
        }while (!inputControl(input,TRAILER_REGEX));
    ...
    public void selectionOfDate() {
        ...
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("d.M.yyyy");
             do {
            input = input();
        }while (!inputControl(input,DATE_REGEX));
    ...
    public void selectionOfItems() {
        ...
        do {
            input = input();
        }while (!inputControl(input,ITEM_REGEX));
            userChoice = input;
    }
    ...
    public boolean inputControl(String input,String regex) {
